...
<?php $table_heading = "Account Transfer Form";?>
                   ...
                   <!-- something to do here !-->
                        ...
                        <?php
                            ...
                            if( isset( $_POST['search'] ) ) 
                            {
                                ...
                                if( $mobile != "" )
                                {
                                    $query = "SELECT FULL_NAME , MEMBER_ID, MOBILE, PRESENT_HOUSE_NO, PRESENT_THANA, PRESENT_DISTRICT FROM member_profiles WHERE MOBILE = '$mobile'" ;
                                }
                                else
                                {
                                    $query = "SELECT FULL_NAME , MEMBER_ID, MOBILE, PRESENT_HOUSE_NO, PRESENT_THANA, PRESENT_DISTRICT FROM member_profiles WHERE MEMBER_ID = '$memberid'" ;
                                }
...
<div>
            ...
            <div class="block">
                ...
                <!-- Form Validation Example Content -->
                 ...
                 <form id="form-validation" action="actions/transfer_account.php" method="post" class="form-horizontal form-bordered" novalidate="novalidate" name="form-validation" enctype="multipart/form-data" >
                    
                    <input type = "hidden" name = "previous" value = "<?php echo $member_identity ;?>" >
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Transfer Information</legend>
                        <div class="form-group">
                        <label class="col-md-2 control-label" for="example-text-input">Transfer Reason<span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            <textarea type="text" id="reason" name="reason" class="form-control" placeholder="Transfer Reason" ></textarea>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <input type="text" id="val_memberno" value = "<?php echo $member_id['MEMBER_NO'] + 1 ; ?>" name="val_memberno"  class="form-control ui-wizard-content" placeholder="Add Member ID" required="" aria-required="true"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control search" style="width: 100%;" name="val_nationality" id="val_nationality" >
                    ...
                    <div class="col-sm-6">
                     <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-md-8">
                        		<select id="val_districtPresent" name="val_districtPresent" class="form-control ui-wizard-content search" style="width: 100%;">
                        			<option value="">Please select</option>
                        			<?php
                        			        $all64 = "Bagerhat,Bandarban,Barguna,Barishal,Bhola,Bogura,Brahmanbaria,Chandpur,Chattogram,Chuadanga,Cumilla,Coxs Bazar,
                        			        Dhaka,Dinajpur,Faridpur,Feni,Gaibandha,Gazipur,Gopalganj,Habiganj,Jaipurhat,Jamalpur,Jashore,Jhalakati,Jhenaidah,
                ...
                <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_postcodePresent">Post Code</label>
                            <div class="col-md-8">
                 ...
                 <legend class="scheduler-border"><strong>Permanent Address</strong></legend>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-md-8">
                        		<select id="val_zillaPermanent" name="val_districtPermanent" class="form-control ui-wizard-content search" style="width: 100%;">
                        			<option value="">Please select</option>
                        			<?php
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_postcodePermanent">Post Code</label>
                            <div class="col-md-8">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type = "hidden" id = "nominee_name" name = "nominee_name" value = "nominee_name" > 
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <input type = "hidden" id = "nominee_relation" name = "nominee_relation" value = "nominee_relation" >
                        ...
                        <div class="col-md-8">
                            ...
                            <input type = "hidden" id = "nominee_add" name = "nominee_add" value = "" >       
                        </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-8">
                                 ...
                                 <input type = "hidden" id = "nominee_mobile" name = "nominee_mobile" value = "" > 
                                </div>
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-md-8">
                                ...
                                <input type = "hidden" id = "nominee_id_type" name = "nominee_id_type" value = "nominee_id_type" > 
                        	</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <div class = "col-md-10 error" id="erval_nidnominee" >
                                    ...
                                    <input type = "hidden" id = "nominee_id_no" name = "nominee_id_no" value = "nominee_id_no" > 
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class = "col-md-8">
                                  ...
                                  <div class = "col-md-10 error" id="erval_pernominee" >
                                    ...
                                    <input type = "hidden" id = "nominee_percentage" name = "nominee_percentage" value = "nominee_percentage" > 
                                  </div>
...
<!--<script type="text/javascript" src="../js/formValidation/formValidation.js"></script>       -->
 <script>
    ...
    {
        var nom_name = ""; var nom_add = "" ; var nom_rel = ""; var nom_mob = "" ; var nom_per = "" ; var nom_id_type = "" ; var nom_id_no = "" ;
        ...
        $("#same").click(function() {
            if (this.checked) {
                ...
                $("#val_zillaPermanent").val( val_districtPresent ) ;
        ...
        $( "#add").on ( "click", function( ){
            ...
            $("#nominee_name").val( nom_name ) ;
            $("#nominee_relation").val( nom_rel ) ;
            $("#nominee_add").val( nom_add ) ;
            $("#nominee_mobile").val(nom_mob ) ;
            $("#nominee_id_type").val(nom_id_type ) ;
            $("#nominee_id_no").val(nom_id_no ) ;
            $("#nominee_percentage").val( nom_per ) ;
            
            console.log( $("#nominee_name").val( ).trim()  ) ;
            console.log( $("#nominee_relation").val().trim()  ) ;
            console.log( $("#nominee_add").val( ).trim()  ) ;
            console.log( $("#nominee_mobile").val( ).trim()  ) ;
            console.log( $("#nominee_id_type").val( ).trim()  ) ;
            console.log( $("#nominee_id_no").val( ).trim()  ) ;
            console.log( $("#nominee_percentage").val( ).trim()  ) ;
            // end updating hidden value field //
