...
<?php $table_heading = "Office Expense";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>


<form class='cmxform form-horizontal' action="" id="raw_material_supplier_form">
    <div class='form-group'><label for='material_category' class='control-label col-lg-4'>Select Expense Head </label>
        <div class='col-lg-4'>
            ...
            <div class="col-sm-6">
                ...
                <div class='form-group'>
                    <div class='pull-right'>
                        <input type='button' class='btn btn-primary' table_name='sd_xass' id='add_receive' value='Add' />
                    </div>
                </div>
...
<table class='table table-bordered table-hover table-responsive table-condensed table-striped dataTable col-xs-12 col-sm-12 col-md-6 col-lg-6 '>
 ...
 <script>
    ...
    function handMadeSaveData( handMadeSaveData , expense_head_no, date ,payment_mode, bank_name,  account_no ,  account_name ,  branch_name, 
    payment_amount, cheque_no, receive_remarks  )
            {
                console.log( "here" ) ;
                $.ajax( { 
                    ...
                    method : "post",
                    data : ({ "handMade": handMadeSaveData , "expense_head_no": expense_head_no, "date": date ,"payment_mode":payment_mode, "bank_name":bank_name, 
                    "account_no":account_no ,  "account_name":account_name ,  "branch_name":branch_name, "payment_amount":payment_amount, 
                    "cheque_no": cheque_no , "receive_remarks": receive_remarks }),
                    dataType: "html",
    ...
    // function disableSelected(data) {
    //     for (i = 0; i < data.length; i++) {
    //         $('#account_no option[value="' + data[i] + '"]').attr("disabled", true);
...
////////////////////////////////handMade Insert Data ////////////////////////////////////////////////////////////////////
            ...
            var expense_head_no = $("#pay_for" ).val() ;
            ...
            handMadeSaveData( "handMadeSaveData1" , expense_head_no, date ,payment_mode, bank_name,  account_no ,  account_name ,  branch_name, 
    payment_amount, cheque_no, receive_remarks  ) ;
