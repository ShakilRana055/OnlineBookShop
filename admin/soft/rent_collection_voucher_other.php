...
<?php
  ...
  $member_information = "" ;
  $present_address = "" ;
  if( isset($_GET['revenue_rent_no']) && isset( $_GET['paid_date']) ) 
  {
     // echo "tor maire bap" ;
    $revenue_rent_no = $_GET['revenue_rent_no'] ;
    $paid_date = $_GET['paid_date'] ;
    $sql = "SELECT `NAME`,`PHONE`,`PERMANENT_ADDRESS` FROM revenue_part_rents WHERE REVENUE_PART_RENT_NO = '$revenue_rent_no'" ;
   ...
   <form id="form-validation" style="padding:20px;" action="actions/test.php" method="post" class="form-horizontal form-bordered" novalidate="novalidate" name="form-validation" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                    <input type="text" disabled id="val_fullname" name="val_fullname" value="<?=$member_information['NAME']?>" style="color:black">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-4 control-label" for="val_fullname"> মোবাইল নম্বর  : <span class="text-danger"></span> </label>
                            <div class="col-md-8">
                                    <input type="text" disabled id="val_fullname" name="val_fullname"   value="<?=$member_information['PHONE']?>" style="color:black">
                    ...
                    <div class="col-sm-12">
                            ...
                            <div class="col-md-10">
                                    <input type="text" disabled id="val_fullname" name="val_fullname" value="<?=$member_information['PERMANENT_ADDRESS']?>"  style="color:black">
...
<table class="table table-bordered table-hover table-responsive table-condensed table-striped dataTable col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
	...
	<tbody id="recordList">
      ...
      $sql = "SELECT * FROM revenue_part_schedule WHERE REVENUE_PART_RENT_NO = '$revenue_rent_no' AND PAID_DATE = '$paid_date'" ;
      ...
      foreach ($result as $value) {
        echo "<tr>";
          ...
          echo "<td style='text-align:center;'>Rent Collection</td>";
